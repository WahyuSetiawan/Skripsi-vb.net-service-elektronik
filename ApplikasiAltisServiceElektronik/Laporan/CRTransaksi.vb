...
Public Class CRTransaksi
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ApplikasiAltisServiceElektronik.CRTransaksi.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRTransaksi
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRTransaksi = New CRTransaksi()
        rpt.Site = Me.Site
        Return rpt
    End Function
