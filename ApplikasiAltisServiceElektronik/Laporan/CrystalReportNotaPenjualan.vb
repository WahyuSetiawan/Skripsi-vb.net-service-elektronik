...
Public Class CrystalReportNotaPenjualan
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CrystalReportNotaPenjualan.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ApplikasiAltisServiceElektronik.CrystalReportNotaPenjualan.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_ID_Transaksi() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCrystalReportNotaPenjualan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportNotaPenjualan = New CrystalReportNotaPenjualan()
        rpt.Site = Me.Site
        Return rpt
    End Function
