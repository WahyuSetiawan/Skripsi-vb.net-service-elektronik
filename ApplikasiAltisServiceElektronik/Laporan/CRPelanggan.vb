...
Public Class CRPelanggan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ApplikasiAltisServiceElektronik.CRPelanggan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRPelanggan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRPelanggan = New CRPelanggan()
        rpt.Site = Me.Site
        Return rpt
    End Function
